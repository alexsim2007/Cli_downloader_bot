...
require_relative 'cli_downloader_bot/organizer'
require_relative 'cli_downloader_bot/file_processing_service'
...
require_relative 'cli_downloader_bot/states/awaiting_metadata'
